...
class ClientTest(unittest.TestCase):
    ...
    def test_getDataPoint_calculatePriceBidEqualAsk(self):
        quotes = [
            ...
            {'top_ask': {'price': 122.54, 'size': 4}, 'timestamp': '2019-02-11 22:06:30.572453',
                'top_bid': {'price': 122.50, 'size': 81}, 'id': '0.109974697771', 'stock': 'GHI'},
        ]
        for quote in quotes:
            self.assertEqual(getDataPoint(quote), (quote['stock'], quote['top_bid']['price'], quote['top_ask']['price'], (
                quote['top_bid']['price'] + quote['top_ask']['price'])/2))
    ...
    def test_getDataPoint_calculatePriceBidZero(self):
        quotes = [
            {'top_ask': {'price': 156.48, 'size': 27}, 'timestamp': '2019-02-11 22:06:30.572453',
                'top_bid': {'price': 0, 'size': 109}, 'id': '0.109974697771', 'stock': 'ABC'},
            {'top_ask': {'price': 141.68, 'size': 7}, 'timestamp': '2019-02-11 22:06:30.572453',
             'top_bid': {'price': 0, 'size': 81}, 'id': '0.109974697771', 'stock': 'DEF'},
            {'top_ask': {'price': 112.54, 'size': 4}, 'timestamp': '2019-02-11 22:06:30.572453',
                'top_bid': {'price': 0, 'size': 81}, 'id': '0.109974697771', 'stock': 'GHI'},
        ]
        for quote in quotes:
            self.assertEqual(getDataPoint(quote), (quote['stock'], quote['top_bid']['price'], quote['top_ask']['price'], (
                quote['top_bid']['price'] + quote['top_ask']['price'])/2))
    ...
    def test_getDataPoint_calculatePriceAskZero(self):
        quotes = [
            ...
            {'top_ask': {'price': 0, 'size': 4}, 'timestamp': '2019-02-11 22:06:30.572453',
             'top_bid': {'price': 121.68, 'size': 81}, 'id': '0.109974697771', 'stock': 'DEF'},
            {'top_ask': {'price': 0, 'size': 4}, 'timestamp': '2019-02-11 22:06:30.572453',
                'top_bid': {'price': 122.54, 'size': 81}, 'id': '0.109974697771', 'stock': 'GHI'},
        ]
